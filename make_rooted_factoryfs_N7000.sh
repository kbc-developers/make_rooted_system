...
mkdir -p ./out
cd ./bin/ext4_utils
sudo ./make_ext4fs -s -l 893386752 -a system ../../out/factoryfs.img ../../$FACTORYFS_DIR
...
cd out
tar cvf GT-N7000XXX-ROOTED-FACTORYFS.tar factoryfs.img
md5sum -t GT-N7000XXX-ROOTED-FACTORYFS.tar >> GT-N7000XXX-ROOTED-FACTORYFS.tar
mv GT-N7000XXX-ROOTED-FACTORYFS.tar GT-N7000XXX-ROOTED-FACTORYFS.tar.md5
