...
mkdir -p ./out
cd ./bin/ext4_utils
sudo ./make_ext4fs -s -l 1570766848 -a system ../../out/system.img.ext4 ../../$FACTORYFS_DIR
...
cd out
tar cvf SC05D-ROOTED-system.tar system.img.ext4
md5sum -t SC05D-ROOTED-system.tar >> SC05D-ROOTED-system.tar
mv SC05D-ROOTED-system.tar SC05D-ROOTED-system.tar.md5
